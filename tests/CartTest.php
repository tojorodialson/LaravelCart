...
namespace Codise\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Codise\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Codise\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Codise\Shoppingcart\ShoppingcartServiceProvider;
use Codise\Tests\Shoppingcart\Fixtures\ProductModel;
use Codise\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Codise\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Codise\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Codise\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \Codise\Shoppingcart\Cart
     */
